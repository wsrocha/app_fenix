  ...
  <thead>
    ...
    <tbody>
      ...
      <?php 
        ...
        $sql_logs = "SELECT * FROM tb_leads";
        $resultado = mysqli_query($conexao, $sql_logs);
        while ($dados = mysqli_fetch_array($resultado)):
       ?>

       <tr>
      <td><?php echo $dados['lead_name']; ?></td>
      <td><?php echo $dados['lead_email']; ?></td>
      <td><?php echo $dados['lead_phone']; ?></td>
      <td><?php echo $dados['lead_product']; ?></td>
...
<div id="btvoltar">
  <a class="waves-effect btn-flat" href="relatorios.php">Voltar</a>
</div>
