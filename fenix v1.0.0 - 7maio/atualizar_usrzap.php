...
if(isset($_GET['id'])):
  ...
  $sqlquery = "SELECT * FROM tb_zapier_users WHERE usrzap_id = '$id' AND usrzap_deleted IS NULL";
...
<form action="action_atualizar_usrzap.php" method="POST">


  <input type="hidden" name="id" value="<?php echo $dados['usrzap_id']; ?>">


  <div class="input-field col s12">
    
    <input type="text" name="nome" id="nome" value="<?php echo $dados['usrzap_name']; ?>">
  ...
  <div class="input-field col s12">
    ...
    <input type="email" name="email" id="email" class="validate" value="<?php echo $dados['usrzap_email']; ?>">
  ...
  <div class="input-field col s12">
    ...
    <input type="text" name="ambiente" id="ambiente" value="<?php echo $dados['usrzap_company']; ?>">
...
<button type="submit"  class="waves-effect waves-light btn #9ccc65 light-green lighten-1">SALVAR</button>
