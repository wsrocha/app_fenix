...
<br><br>
    ...
    <div id="opt-menu">
            ...
            <div class="opt-item">
            <a href="usuarios.php"><i class="material-icons">person</i> <br>
            <p>Usuários</p>
            </a></div>


            <div class="opt-item">
            <a href="sistema_logs.php"><i class="material-icons">report_problem</i>
            <p>Logs do sistema</p></a>
            </div>

            <div class="opt-item">
            <a href="sys_status.php"><i class="material-icons">wb_cloudy</i>
            <p>Status do sistema</p></a>
            </div>
